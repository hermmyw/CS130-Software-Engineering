 ...
 *  from CircularShift. Methods to access sorted lines are provided.
 *  @author  dhelic
 *  @version $Id$
*/
...
/**
 * CircularShift that provides lines
 *
 */

  private CircularShift shifter_;
 ...
 */
  ...
  public void alpha(CircularShift shifter){
    shifter_ = shifter;
 ...
 */
 ...
 /** 
  *  added by vibha.
  *  according to Parnas' paper, gives the index of the circular
  *  shift which comes ith in the alphabetical ordering
  * @param i
