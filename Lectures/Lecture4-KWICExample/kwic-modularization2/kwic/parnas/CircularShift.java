...
/**
 *  An object of the CircularShift class produces and holds all circular shifts of
 *  a set of lines. In principle, the CircularShift class provides a
 *  similar interface as the LineStorage class, thus allowing to manipulate 
 *  the lines that it holds. However, in the case of the CircularShift
 *  class the lines are actually circular shifts of a particular set of original
 *  lines. Also, the CircularShift class does not provide interface for
